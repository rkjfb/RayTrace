...
void Sphere::local_intersect(const Ray& local_ray, std::pmr::vector<Intersection>& out) const {
...
void Plane::local_intersect(const Ray& local_ray, std::pmr::vector<Intersection>& out) const {
